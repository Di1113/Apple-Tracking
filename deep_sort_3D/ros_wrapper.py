...
def read_cameras():
    ...
    print("Registered ROS Callbacks")
    rospy.spin()
...
def image_callback(imageL, imageR):
    try:
        ...
        ############################  Detection Model #############################################
        yolo_dets,scores,_=tracker.detector.pred(cv2.cvtColor(frame_left.copy(),cv2.COLOR_BGR2RGB), debug=False)      
...
if __name__ == '__main__':
    ...
    print("Created YOLOv8 Detector")

    #Declare segmentation object
    segmentation= Segmentation()
    print("Created Segmentation Model")
